...
let resetBoard = [
    [{Value:1,Owner:"a"},{Value:0,Owner:""},{Value:0,Owner:""},{Value:0,Owner:""},{Value:0,Owner:""}],
    [{Value:0,Owner:""},{Value:5,Owner:"b"},{Value:0,Owner:""},{Value:0,Owner:""},{Value:0,Owner:""}],
    ...
    [{Value:2,Owner:"a"},{Value:0,Owner:""},{Value:0,Owner:""},{Value:0,Owner:""},{Value:0,Owner:""}]
];
...
<Slide active={data.active}>
    ...
    <div slot="right" class="w-full h-full flex flex-col text-black mt-4">
        <h1 class="text-center font-alloy text-2xl">Exceptionals</h1>
        <p>
            But combat has 2 exceptions. 1 beats 5 and 2 beats 4. You can check it yourself above.
            (Balanced as all things should be :P)
        </p>
        <p class="mt-1">Move your units by clicking on a blue sqaure with value and
